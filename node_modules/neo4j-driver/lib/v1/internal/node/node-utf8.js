...
var _combinedBuf = require('../buf/combined-buf');

var _combinedBuf2 = _interopRequireDefault(_combinedBuf);

var _nodeBuf = require('../node/node-buf');
...
function encode(str) {
  return new _nodeBuf2.default(newNodeJSBuffer(str));
}

function decode(buffer, length) {
  if (buffer instanceof _nodeBuf2.default) {
    return decodeNodeBuffer(buffer, length);
  } else if (buffer instanceof _combinedBuf2.default) {
...
function newNodeJSBuffer(str) {
  ...
  return typeof _buffer2.default.Buffer.from === 'function' ? _buffer2.default.Buffer.from(str, 'utf8') : new _buffer2.default.Buffer(str, 'utf8');
}
