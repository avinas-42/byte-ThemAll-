  ...
  (0, _createClass3.default)(Transaction, [{
    ...
    value: function _begin(bookmark, txConfig) {
      ...
      this._connectionHolder.getConnection(streamObserver).then(function (conn) {
        return conn.protocol().beginTransaction(bookmark, txConfig, streamObserver);
...
var _TransactionStreamObserver = function (_StreamObserver) {
  ...
  function _TransactionStreamObserver(tx) {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, (_TransactionStreamObserver.__proto__ || (0, _getPrototypeOf2.default)(_TransactionStreamObserver)).call(this));
    ...
    value: function onError(error) {
      ...
      if (!this._hasFailed) {
        this._tx._onError().then(function () {
          (0, _get3.default)(_TransactionStreamObserver.prototype.__proto__ || (0, _getPrototypeOf2.default)(_TransactionStreamObserver.prototype), 'onError', _this2).call(_this2, error);
        });
      }
    }
  }, {
...
var _states = {
  ...
  ACTIVE: {
    ...
    run: function run(connectionHolder, observer, statement, parameters) {
      ...
      var bookmark = _bookmark2.default.empty();
      var txConfig = _txConfig2.default.empty();

      connectionHolder.getConnection(observer).then(function (conn) {
        return conn.protocol().run(statement, parameters, bookmark, txConfig, observer);
      }).catch(function (error) {
...
function finishTransaction(commit, connectionHolder, observer) {
  ...
  return new _result2.default(observer, commit ? 'COMMIT' : 'ROLLBACK', {}, emptyMetadataSupplier, connectionHolder);
}
